...
// Build file paths relative to the current website location
...
if (featuredImg) {
  ...
  featuredImg.onerror = function () {
    console.error("Featured image failed to load:", P.featured.image);
  };
}
      ...
      p => `
        <article class="project-card">
          <img 
            ...
            alt="${p.title}" 
            loading="lazy"
            onerror="this.style.display='none'; console.error('Image failed to load:', '${p.image}')"
          >
